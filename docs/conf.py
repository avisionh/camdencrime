# camdencasualties documentation build configuration file
#
...
htmlhelp_basename = "camdencasualtiesdoc"
...
latex_documents = [
    ("index",
     "camdencasualties.tex",
     u"camdencasualties Documentation",
     u"avisionh", "manual"),
]
...
man_pages = [
    ("index", "camdencasualties", u"camdencasualties Documentation",
     [u"avisionh"], 1)
]
...
texinfo_documents = [
    ("index", "camdencasualties", u"camdencasualties Documentation",
     u"avisionh", "camdencasualties",
     "Exploratory analysis of Camden road casualty data.", "Miscellaneous"),
]
